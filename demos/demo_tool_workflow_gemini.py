...
4. GeminiAgent using tools through the registry
"""
...
def main():
    ...
    logger.info("\nStep 2: Initializing Gemini agent...")
    agent = GeminiAgent()
    
    if not agent.client:
        print("\n[!] Warning: Gemini client not initialized (missing API key)")
    ...
    print("[OK] Gemini agent initialized\n")
    
    # 4. Test workflow: Ask Gemini to create a test file
    print("="*70)
    ...
    response1 = agent.run(task1, tools_registry=registry)
    print(response1)
    print("-" * 70)
    ...
    response2 = agent.run(task2, tools_registry=registry)
    print(response2)
    print("-" * 70)
    ...
    response3 = agent.run(task3, tools_registry=registry)
    print(response3)
    print("-" * 70)
    ...
    print("[OK] Gemini agent using tools successfully")
